...
fn test_round_trip_bag_to_mcap_sequential() {
    ...
    let reader =
        RoboReader::open_with_strategy(bag_file.to_str().unwrap(), ReadStrategy::Sequential)
    ...
    let mcap_reader =
        RoboReader::open_with_strategy(mcap_file.to_str().unwrap(), ReadStrategy::Sequential)
...
fn test_round_trip_bag_mcap_bag() {
    ...
    let reader1 =
        RoboReader::open_with_strategy(original_bag.to_str().unwrap(), ReadStrategy::Sequential)
    ...
    let reader2 = RoboReader::open_with_strategy(
    ...
    let final_reader =
        RoboReader::open_with_strategy(final_bag.to_str().unwrap(), ReadStrategy::Sequential)
